 ...
 * @author Vukos
 */
public class FormNoviSladoled extends javax.swing.JDialog {

    public FormNoviSladoled(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Dodavanje sladoleda");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Unos sladoleda"));
        ...
        txtNazivSastojka.setText("Mleko");
        ...
        btnDodaj.setText("Dodaj sladoled");
        ...
        txtNazivSladoleda.setText("Quatro");

        txtOpis.setColumns(20);
        txtOpis.setRows(5);
        txtOpis.setText("Vrlo ukusan.");
    ...
    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
        try {
            ...
            Sladoled s = new Sladoled(null, nazivSladoleda, opis, cena,  tm.getLista());
            
            ClientController.getInstance().addSladoled(s);
            JOptionPane.showMessageDialog(this, "Sistem je kreirao sladoled!");
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormNoviSladoled.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormNoviSladoled dialog = new FormNoviSladoled(new javax.swing.JFrame(), true);
